...
double rad_adj_c1(double rad) {
	if (rad < 270.0)rad = 270.0 - rad;
	if (270.0 < rad && rad < 360.0)rad = 360.0 - rad + 270.0;
	return rad;
}

double rad_adj_c2(double rad) {
	if (rad < 90.0)rad = 90.0 - rad;
	if (90.0 < rad)rad = 360.0 - rad + 90.0;
	return rad;
}
